...
const CarouselCollection = () => {
  ...
  return (
    <div className="mt-20">
      ...
      <div>
        <div className="mb-5 flex justify-between max-w-[1200px] mx-auto ">
          <h1 className="sm:text-lg text-gray-200 trucante max-w-[800px]">
          ...
          <h1 className="text-xl font-medium text-white ml-20">
            View All -{'>'}
          </h1>
        </div>
      </div>
