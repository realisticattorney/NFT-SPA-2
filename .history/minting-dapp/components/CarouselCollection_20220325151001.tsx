  ...
  return (
    <div className="mt-20">
      <div className="mb-5 max-w-[1200px] mx-auto">
        <h1 className="text-3xl font-bold text-dexfi-light_cyan z-30 px-6 sm:px-0">
          Collection
        </h1>
      </div>
      <div className="h-[100px] w-[0px] absolute lalalala3 right-10 top-100"></div>
      <div className=" z-30 mt-4 mb-6  sm:mb-10 max-w-[1200px] mx-auto">
        <Carousel
          infiniteLoop
          showStatus={false}
          showThumbs={false}
      ...
      <div>
        <div className="sm:mb-5 flex justify-between max-w-[1200px] mx-auto px-6 sm:px-0">
