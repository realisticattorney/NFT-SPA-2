  ...
  return (
    <div className="max-w-[1200px] mx-auto">
      <div className="mb-8 flex justify-between z-0">
        <h1 className="text-xl font-semibold textGradientReverse z-50">Mint Demons Gaze</h1>
        <h1 className="text-xl font-medium text-white">View Contract -{'>'}</h1>
      </div>
      ...
      <div className=" glossy text-white p-10 z-20">
        ...
        {!userAddress || !isSoldOut() ? (
          <div className="no-wallet">
            {!userAddress ? (
              <button
                className="w-[152px]  font-bold py-1 px-5 text-white hover:opacity-75 transition-opacity duration-300 active:translate-y-0.1 active:shadow-none active:opacity-90
