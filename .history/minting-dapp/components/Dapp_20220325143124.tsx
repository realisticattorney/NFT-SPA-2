      ...
      <div className=" glossy text-white p-10 z-20">
        ...
        {!userAddress || !isSoldOut() ? (
          <div className="no-wallet">
            {!userAddress ? (
              <button
                className="w-[152px]  font-bold py-1 px-3 text-white hover:opacity-75 transition-opacity duration-300 active:translate-y-0.1 active:shadow-none active:opacity-90
