  ...
  return (
    <div className="max-w-[1200px] mx-auto px-6">
      <div className="mb-4 sm:mb-8 flex justify-between z-0">
        <h1
          className="text-lg sm:text-xl font-semibold textGradientReverse z-50"
          id="mint"
        >
          Mint Demons Gaze
        </h1>
        <a
          href="https://rinkeby.etherscan.io/address/0xb966a41C4a5D25A6Eb2c776C90004D7256FCF690://testnets.opensea.io/collection/monster-eye-v2"
          target="_blank"
          rel="noreferrer"
