...
const Faq = (props) => {
  return (
    <div className=" w-full px-6 mt-20  font-mono">
      <h1 className="text-5xl text-center font-extrabold  mb-8 text-dexfi-pink">
        FAQ
      </h1>
