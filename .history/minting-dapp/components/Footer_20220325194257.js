            ...
            >
              <div className=''>
                ...
                <input
                  ...
                  className={`block border rounded-none shadow-sm bg-deepoe-cream text-sm text-black font-light font-mono  py-1 px-1.5 placeholder-gray-700 focus:ring-deepoe-chocolate focus:border-deepoe-chocolate border-gray-600 focus:outline-none focus:ring-1 resize-none ${
