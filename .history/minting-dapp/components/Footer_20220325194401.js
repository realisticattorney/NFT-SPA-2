            ...
            <form onSubmit={handleSubmit(onSubmitForm)} className="flex">
              <div className="">
                ...
                <input
                  ...
                  className={`block border rounded-none shadow-sm bg-deepoe-cream text-sm text-gray-800 font-light font-mono  py-1 px-1.5 placeholder-gray-700 focus:ring-deepoe-chocolate focus:border-deepoe-chocolate border-gray-600 focus:outline-none focus:ring-1 resize-none ${
              ...
              <div className="justify-self-end">
               ...
               bg-gradient-to-r from-dexfi-cyan to-dexfi-pink lalalala borderGradientReverse focus:outline-none focus:ring-1 focus:ring-offset-2 active:outline-none"
                >
                  Submit
                </button>
              </div>
