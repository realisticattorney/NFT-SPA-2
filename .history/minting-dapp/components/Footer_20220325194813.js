            ...
            <form onSubmit={handleSubmit(onSubmitForm)} className="flex">
              <div className="">
                ...
                <input
                  ...
                  className={`block border font-inter rounded-none shadow-sm bg-deepoe-cream text-xs1 text-gray-800 font-light  py-1.5 px-1.5 placeholder-gray-700 focus:ring-deepoe-chocolate focus:border-deepoe-chocolate border-gray-600 focus:outline-none focus:ring-1 resize-none ${
