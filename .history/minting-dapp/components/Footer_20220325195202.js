    ...
    <footer className=" text-white  font-medium  p-0 sm:p-5 max-w-[1200px] mx-auto mt-40">
      <div className="grid grid-cols-1 grid-rows-2 sm:grid-cols-2 sm:grid-rows-1 py-16 border-t border-b border-gray-700">
        ...
        <div className="row-start-1 sm:col-start-2 sm:row-start-2 flex-col sm:min-w-[600px] self-center">
          <div className="sm:w-[300px] mx-auto space-y-5 p-4">
            ...
            <form onSubmit={handleSubmit(onSubmitForm)} className="flex">
              <div className="">
                ...
                <input
                  ...
                  className={`block border font-inter rounded-tl-md rounded-bl-md shadow-sm bg-deepoe-cream text-sm text-gray-800 font-light  py-1.5 px-1.5 placeholder-gray-700 focus:ring-deepoe-chocolate focus:border-deepoe-chocolate border-gray-600 focus:outline-none focus:ring-1 resize-none ${
