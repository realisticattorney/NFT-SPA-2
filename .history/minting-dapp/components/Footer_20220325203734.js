            ...
            <form onSubmit={handleSubmit(onSubmitForm)} className="flex">
              <div className="">
                ...
                <input
                  ...
                  className={`block border font-inter rounded-tl-md rounded-bl-md shadow-sm  text-sm text-gray-800 font-light mb-1 py-1.5 px-1.5 placeholder-gray-700  border-gray-600 focus:outline-none focus:ring-1 resize-none ${
