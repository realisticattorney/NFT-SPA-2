...
const Hero = () => {
  return (
    <div className="w-full grid grid-cols-2 grid-rows-2 sm:grid-rows-1 sm:max-w-[1200px] sm:mx-auto">
      <div className="flex-col px-4 sm:px-6 py-10 sm:py-20 sm:mt-0 flex-grow row-start-1 sm:row-start-1 col-span-2 sm:col-span-1 space-y-6">
      ...
      <div className="col-span-2 sm:col-span-1 sm:col-start-2 relative row-start-2 row-span-1 m-5 sm:m-0 z-0">
        <Image
          src="/images/30.png"
          layout="fill"
          alt="lol"
