      ...
      <div className="flex-col px-4 sm:px-6 py-10 sm:py-0 sm:mt-0 flex-grow row-start-1 sm:row-start-1 col-span-2 sm:col-span-1 space-y-6">
        ...
        <div className="space-x-2">
          <Link href="/swap">
            <a>
              <button
                className="w-[142px]  border-2 font-bold pb-0.7 px-5 text-white hover:opacity-75 transition-opacity duration-300 active:translate-y-0.1 active:shadow-none active:opacity-90
