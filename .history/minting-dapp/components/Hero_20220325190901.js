  ...
  return (
    <div className="w-full grid grid-cols-2 grid-rows-2 sm:mt-10 mb-20 sm:mb-32 sm:grid-rows-1 sm:max-w-[1200px] sm:mx-auto">
      <div className="flex-col px-4 sm:px-6 py-10 sm:py-0 sm:mt-0 flex-grow row-start-1 sm:row-start-1 col-span-2 sm:col-span-1 space-y-6">
        <h1 className="font-serif text-7xl sm:text-8xl tracking-wide font-bold textGradient w-min">
          Demons
          <span className="font-serif block text-7xl sm:text-8xl tracking-wide font-bold textGradient w-min">
            Gaze
          </span>
        </h1>
        ...
        <div className="space-x-2">
          <a>
            <button
              className="  border-2 font-medium text-lg font-mono pb-0.7 pt-0.9 px-7 text-white hover:opacity-75 transition-opacity duration-300 active:translate-y-0.1 active:shadow-none active:opacity-90
        ...
        <div className="">
          <div className="flex font-medium text-white space-x-6 justify-between sm:justify-start">
            <div>
              <h1 className="font-aldrich truncate text-xl text-gray-200">
                2,000
              </h1>
              <h1 className="font-aldrich text-xs1 text-gray-200">Artworks</h1>
            </div>
            <div>
              <h1 className="font-aldrich truncate text-xl text-gray-200">
                1,446
              </h1>
              <h1 className="font-aldrich text-xs1 text-gray-200">Owners</h1>
            </div>
            <div>
              <h1 className="font-aldrich truncate text-xl text-gray-200">
                48,200
              </h1>
              <h1 className="font-aldrich text-xs1 text-gray-200">
                Volume Traded
              </h1>
            </div>
          </div>
