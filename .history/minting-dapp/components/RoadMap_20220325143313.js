...
const RoadMap = () => {
  return (
    <div className="mt-20">
      ...
      <div className="grid grid-cols-4 grid-rows-2 h-[600px] max-w-[1200px] mx-auto glossy gap-4 p-4">
        <div className="hidden sm:col-span-1 sm:relative sm:row-span-1">
          <Image src="/images/34.png" objectFit="cover" layout="fill" />
        </div>
        <div className="col-start-2 relative row-span-1">
          <Image src="/images/20.png" objectFit="cover" layout="fill" />
        </div>
        <div className="col-span-1 relative row-start-2">
        ...
        <div className="col-span-2 row-span-2 flex-col p-5 borderGradient space-y-6">
